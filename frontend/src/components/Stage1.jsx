...
import { Bot, TrendingUp, Medal } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from './ui/card';
import { Badge } from './ui/badge';
import { Avatar, AvatarFallback } from './ui/avatar';
import { cn } from '../lib/utils';

export default function Stage1({ stage1, labelToModel, aggregateRankings }) {
  ...
  const getRankBadge = (label) => {
    ...
    const variant = variants[position] || { className: 'bg-muted', icon: `#${position}` };
